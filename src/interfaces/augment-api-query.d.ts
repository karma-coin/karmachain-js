...
declare module "@polkadot/api-base/types/storage" {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    appreciation: {
       ...
       **/
      ambassadorCharTraitId: AugmentedQuery<
        ApiType,
        () => Observable<Option<u32>>,
        []
      >;
      charTraits: AugmentedQuery<
        ApiType,
        () => Observable<Vec<PalletAppreciationCharTrait>>,
        []
      >;
      communities: AugmentedQuery<
        ApiType,
        () => Observable<Vec<PalletAppreciationCommunity>>,
        []
      >;
      communityMembership: AugmentedQuery<
        ApiType,
        (
          arg1: AccountId32 | string | Uint8Array,
          arg2: u32 | AnyNumber | Uint8Array
        ) => Observable<Option<PalletAppreciationCommunityRole>>,
        [AccountId32, u32]
      >;
      ...
      referrals: AugmentedQuery<
        ...
        [AccountId32, SpCommonIdentityAccountIdentity]
      >;
      /**
       * This is the signup trait - user gets it for signing up
       **/
      signupCharTraitId: AugmentedQuery<
        ApiType,
        () => Observable<Option<u32>>,
        []
      >;
       ...
       **/
      spenderCharTraitId: AugmentedQuery<
        ApiType,
        () => Observable<Option<u32>>,
        []
      >;
      traitScores: AugmentedQuery<
        ApiType,
        (
          arg1: AccountId32 | string | Uint8Array,
          arg2: u32 | AnyNumber | Uint8Array,
    ...
    identity: {
      identityOf: AugmentedQuery<
        ...
        (
          arg: AccountId32 | string | Uint8Array
        ) => Observable<Option<PalletIdentityIdentityStore>>,
        [AccountId32]
      >;
      nameFor: AugmentedQuery<
        ApiType,
        (arg: Bytes | string | Uint8Array) => Observable<Option<AccountId32>>,
        [Bytes]
      >;
      phoneNumberFor: AugmentedQuery<
        ApiType,
        (arg: Bytes | string | Uint8Array) => Observable<Option<AccountId32>>,
        [Bytes]
      >;
      phoneVerifiers: AugmentedQuery<
        ApiType,
    ...
    session: {
      ...
      nextKeys: AugmentedQuery<
        ...
        (
          arg: AccountId32 | string | Uint8Array
        ) => Observable<Option<KarmachainNodeRuntimeOpaqueSessionKeys>>,
        [AccountId32]
      >;
      /**
      ...
      queuedKeys: AugmentedQuery<
        ApiType,
        () => Observable<
          Vec<ITuple<[AccountId32, KarmachainNodeRuntimeOpaqueSessionKeys]>>
        >,
        []
      >;
      /**
    ...
    transactionIndexer: {
      accountTransactions: AugmentedQuery<
        ApiType,
        (
          arg: AccountId32 | string | Uint8Array
        ) => Observable<Option<Vec<ITuple<[u32, u32]>>>>,
        [AccountId32]
      >;
      txHashes: AugmentedQuery<
        ApiType,
        (
          arg: H256 | string | Uint8Array
        ) => Observable<Option<ITuple<[u32, u32]>>>,
