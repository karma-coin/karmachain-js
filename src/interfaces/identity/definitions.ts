export default {
  ...
  rpc: {
    ...
    community: {
      getAllUsers: {
        description:
          "provides list of community members with information about each member account",
        params: [
          {
            name: "community_id",
            type: "u32",
      ...
      getContacts: {
        description:
          "provides list of users who's name starts with `prefix` also can be filtered by `community_id`, `None` mean no filtering",
        params: [
          {
            name: "prefix",
            type: "Text",
