export default {
  ...
  rpc: {
    transactions: {
      getTx: {
        description:
          "Provides transaction details by block number and transaction index",
        params: [
          {
            name: "block_number",
            type: "u32",
      ...
      getTxWithEvents: {
        description:
          "Provides transaction details and transaction events by block number and transaction index",
        params: [
          {
            name: "block_number",
            type: "u32",
