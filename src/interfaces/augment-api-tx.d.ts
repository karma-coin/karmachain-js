...
declare module "@polkadot/api-base/types/submittable" {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    appreciation: {
      appreciation: AugmentedSubmittable<
        (
          to:
            | SpCommonIdentityAccountIdentity
            | {
          ...
          communityId: Option<u32> | null | Uint8Array | u32 | AnyNumber,
          charTraitId: Option<u32> | null | Uint8Array | u32 | AnyNumber
        ) => SubmittableExtrinsic<ApiType>,
        [SpCommonIdentityAccountIdentity, u128, Option<u32>, Option<u32>]
      >;
      setAdmin: AugmentedSubmittable<
        (
          communityId: u32 | AnyNumber | Uint8Array,
          newAdmin:
            | SpCommonIdentityAccountIdentity
            | {
                AccountId: any;
        ...
        [u32, SpCommonIdentityAccountIdentity]
      >;
    };
    authorship: {
      /**
    ...
    identity: {
      newUser: AugmentedSubmittable<
        (
          accountId: AccountId32 | string | Uint8Array,
          name: Bytes | string | Uint8Array,
          phoneNumber: Bytes | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [AccountId32, Bytes, Bytes]
      >;
    };
    session: {
      /**
      ...
      setKeys: AugmentedSubmittable<
        ...
        [KarmachainNodeRuntimeOpaqueSessionKeys, Bytes]
      >;
    };
    staking: {
      /**
