...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    appreciation: {
      NewCommunityAdmin: AugmentedEvent<ApiType, [communityId: u32, communityName: Bytes, accountId: AccountId32, username: Bytes, phoneNumber: Bytes], { communityId: u32, communityName: Bytes, accountId: AccountId32, username: Bytes, phoneNumber: Bytes }>;
    };
    balances: {
      /**
